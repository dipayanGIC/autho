...
export default class AnalyticsPage extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <div className="m-b">
          <h2>AWS Glue Customized Dashbord!</h2>
            ...
            <Card>
              ...
              <CardBody>
                ...
                <i
                  ...
                  aria-hidden="true"
                />
                <Progress value={77} animated color="info" color="info" />
              </CardBody>
            </Card>
          </Col>
          <Col md={4} xs={12}>
          ...
          <Col md={4} xs={12}>
            <Card>
              ...
              <CardBody>
                ...
                <Progress value={77} animated color="warning" color="success" />
              </CardBody>
            </Card>
          </Col>
          <Col md={4} xs={12}>
            <Card>
              ...
              <CardBody>
                ...
                <Progress value={14} animated color="warning" color="danger" />
              </CardBody>
            </Card>
          </Col>
        </Row>
